...
import net.muellersites.advancedsteelmaking.tileentity.InventoryTile;
...
public class ContainerBase<T extends TileEntity> extends Container {
    ...
    public ItemStack slotClick(int id, int button, ClickType clickType, EntityPlayer player) {
        LogHelper.info("slotClick, id: " + id + " button: " + button + " clickType: " + clickType);
        ...
        LogHelper.info("Returning stack: " + String.valueOf(stack));
        return stack;
    }*/

    @Override
    public ItemStack transferStackInSlot(EntityPlayer player, int slot) {
        LogHelper.info("transferStack");
        ItemStack stack = null;
